  ...
  (0, _createClass3.default)(Core, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var okdkGodData, okdkGodContract, okdkData, okdkAddress, okdkContract, tokenData, tokenAddresss, iterableMappingData, iterableMappingAddress, safeMathData, safeMathAddress, databaseData, databaseAddress, databaseTestData, databaseTestAddress;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                /* Load okdk-god abi */
                okdkGodData = okdk.utils.loadJSON(okdk.constants.OKEYDOKEY_GOD_DATA_PATH);

                this._okdkGodAbi = okdkGodData.abi;
                this._okdkGodAddress = '0x98f6621da7b5f3dddcd4bc74310e3f2410350f12';
                okdkGodContract = new okdk.web3.eth.Contract(this._okdkGodAbi, this._okdkGodAddress);

                /* Set up OkeyDokey. */

                okdkData = okdk.utils.loadJSON(okdk.constants.OKEYDOKEY_DATA_PATH);

                this._okdkAbi = okdkData.abi;
                _context2.next = 9;
                return okdkGodContract.methods.getAddress().call();

              case 9:
                okdkAddress = _context2.sent;

                this._okdkAddress = okdkAddress;
                okdkContract = new okdk.web3.eth.Contract(this._okdkAbi, this._okdkAddress);
                ...
                _context2.next = 17;
                return okdkContract.methods.getAddress(0).call();

              case 17:
                tokenAddresss = _context2.sent;
                ...
                _context2.next = 24;
                return okdkContract.methods.getAddress(1).call();

              case 24:
                iterableMappingAddress = _context2.sent;
                ...
                _context2.next = 31;
                return okdkContract.methods.getAddress(2).call();

              case 31:
                safeMathAddress = _context2.sent;

                this._safeMathAddress = safeMathAddress;

                /* Fetch and construct database library. */
                databaseData = okdk.utils.loadJSON(okdk.constants.DATABASE_DATA_PATH);

                this._databseAbi = databaseData.abi;
                this._databaseBytecode = databaseData.bytecode;
                _context2.next = 38;
                return okdkContract.methods.getAddress(3).call();

              case 38:
                databaseAddress = _context2.sent;

                this._databaseAddress = databaseAddress;

                /* Fetch and construct token contract. */
                databaseTestData = okdk.utils.loadJSON(okdk.constants.DATABASE_TEST_DATA_PATH);

                this._databseTestAbi = databaseTestData.abi;
                this._databaseTestBytecode = databaseTestData.bytecode;
                _context2.next = 45;
                return okdkContract.methods.getAddress(4).call();

              case 45:
                databaseTestAddress = _context2.sent;
