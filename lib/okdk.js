...
OKDK.prototype.test = function() {
    ...
    /* Test house methods */
    this.houses.registerHouse("b77e57a8c08eb4d660841c18cc2e78a1a9667a062d7ee6a06211b3597a84783f",1,32)
    .then(result => {
        console.log(result);
    ...
    /* Test storage */
        ...
        return this.storage.uploadJSON(data);

    }).then(result => {
        console.log(result);

        return this.storage.downloadJSON(result);
